<template>
  <div class="space-y-12">
    <header class="space-y-4 text-center md:text-left">
      ...
      <h1 class="text-4xl font-semibold text-slate-100 md:text-5xl">Age Calculator</h1>
      <p class="max-w-3xl text-base text-slate-400 md:text-lg">
        Calculate exact age in years, months, days, next birthday, and total days/weeks/hours.
      </p>
    </header>
    <AgeCalculator />
  </div>
